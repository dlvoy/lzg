...
var createLzgModule = (() => {
  ...
  return (
function(createLzgModule) {
  createLzgModule = createLzgModule || {};
...
var Module = typeof createLzgModule !== 'undefined' ? createLzgModule : {};
...
Module['ready'] = new Promise(function(resolve, reject) {
  ...
  readyPromiseReject = reject;
      ...
      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_compress_lzg')) {
        Object.defineProperty(Module['ready'], '_compress_lzg', { configurable: true, get: function() { abort('You are getting _compress_lzg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_compress_lzg', { configurable: true, set: function() { abort('You are setting _compress_lzg on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_LZG_MaxEncodedSize')) {
        Object.defineProperty(Module['ready'], '_LZG_MaxEncodedSize', { configurable: true, get: function() { abort('You are getting _LZG_MaxEncodedSize on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_LZG_MaxEncodedSize', { configurable: true, set: function() { abort('You are setting _LZG_MaxEncodedSize on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_LZG_DecodedSize')) {
        Object.defineProperty(Module['ready'], '_LZG_DecodedSize', { configurable: true, get: function() { abort('You are getting _LZG_DecodedSize on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_LZG_DecodedSize', { configurable: true, set: function() { abort('You are setting _LZG_DecodedSize on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
    

      if (!Object.getOwnPropertyDescriptor(Module['ready'], '_LZG_Decode')) {
        Object.defineProperty(Module['ready'], '_LZG_Decode', { configurable: true, get: function() { abort('You are getting _LZG_Decode on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
        Object.defineProperty(Module['ready'], '_LZG_Decode', { configurable: true, set: function() { abort('You are setting _LZG_Decode on the Promise object, instead of the instance. Use .then() to get called back with the instance, see the MODULARIZE docs in src/settings.js') } });
      }
...
/** @type {function(...*):?} */
var _LZG_MaxEncodedSize = Module["_LZG_MaxEncodedSize"] = createExportWrapper("LZG_MaxEncodedSize");
...
/** @type {function(...*):?} */
var _LZG_DecodedSize = Module["_LZG_DecodedSize"] = createExportWrapper("LZG_DecodedSize");

/** @type {function(...*):?} */
var _LZG_Decode = Module["_LZG_Decode"] = createExportWrapper("LZG_Decode");

/** @type {function(...*):?} */
var _compress_lzg = Module["_compress_lzg"] = createExportWrapper("compress_lzg");
...
run();
  ...
  return createLzgModule.ready
}
);
})();
if (typeof exports === 'object' && typeof module === 'object')
  module.exports = createLzgModule;
else if (typeof define === 'function' && define['amd'])
  define([], function() { return createLzgModule; });
else if (typeof exports === 'object')
  exports["createLzgModule"] = createLzgModule;
